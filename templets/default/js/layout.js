/*
Cache: jquery-lazy, thickbox, dt-main, dt-language, dt-main-op-jquery, dt-plugins, waypoints, vc_carousel_js, vc_transition_bootstrap_js, qfe_composer_front_js, wc-cart-fragments, jquery-cookie, bitcommerce, jquery-blockui, jquery-form, jquery-migrate, jquery-core
*/
/* jquery-core: (https://www.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (https://www.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* jquery-form: (https://www.qifeiye.com/qfy-includes/js/jquery/jquery.form.min.js) */
/*!
 * jQuery Form Plugin
...
/* jquery-blockui: (https://www.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* bitcommerce: (https://www.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/bitcommerce.min.js) */
			...
			$('.productlists.add_to_cart_button').unbind().bind('click', function() {
				...
				if ( $thisbutton.is('.product_type_simple') ) {
					...
					$.post( "admin/admin-ajax.php", data, function( response ) {
						...
						qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="images/check.png" style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;">'+wc_add_to_cart_params.i18n_ajax_title+'</div></div>',wc_add_to_cart_params.i18n_ajax_closetime>1?wc_add_to_cart_params.i18n_ajax_closetime:1)
			...
			jQuery(obj).closest("form").ajaxSubmit({
				success:function(data){
					...
					if(obj.status=="success"){
						var htm = obj.msg;
						if(isajax==2){
							qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="images/check.png" style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;line-height:30px;">'+text3+'</div></div>',3)
						}else if(isajax==3){
							var body_w = jQuery("body").width();
							if(body_w<=992){
								qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="images/check.png" style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;line-height:30px;">'+text3+'</div></div>',3)
...
function _cart_update(obj,e){
	...
	sidebar.block({message: null, overlayCSS: {background: '#fff url() no-repeat center', backgroundSize: '16px 16px', opacity: 0.6}});
...
function get_one_coupon(obj){
	...
	if(jQuery(obj).hasClass("loading") ){
		...
		jQuery(obj).addClass("loading").append("<div class='loadingdiv' style='width:100%;height:100%;position:absolute;top:0;left:0;;background:url() no-repeat center rgba(255,255,255,0.2)'></div>");
	}
...
/* jquery-cookie: (https://www.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-cookie/jquery.cookie.min.js) */
/*!
...
/* wc-cart-fragments: (https://www.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/cart-fragments.min.js) */
...
/* qfe_composer_front_js: (https://www.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
	...
	if(jQuery(".swiper-container:not(.loaded)").length>0){
		 if(typeof jQuery.fn.Swiper=="undefined"){
			 jQuery.getScript("FeiEditor/bitSite/js/swiper/swiper-4.1.0.min.js").done(function() {
				 jQuery('head').append('<link href="css/swiper-4.1.0.min.css" rel="stylesheet" type="text/css" />');
				 swiper_event();
			 })
		 }else{
			 swiper_event();
	...
	if(	jQuery('.qfy-jiathis').length>0){
		if(typeof jQuery.fn.share !="function"){
			 jQuery.getScript("FeiEditor/bitSite/js/share/jquery.share.min.js").done(function() {
				 jQuery('head').append('<link href="css/share.min.css" rel="stylesheet" type="text/css" />');
		...
		jQuery( ".background-media.mediagallery:not(.loaded)" ).each(function(){
	     ...
	     if(jQuery(".qfy-comments .commentlist:hidden").length>0){
			jQuery(".qfy-comments").each(function(){
				...
				var loadhtml = "<div class='commentlist_loading' style='text-align:center;height:30px;margin:15px auto;' ><img src='images/loader.gif' /></div>";
...
function bit_counterdown(){
	 ...
	 if(typeof jQuery.fn.countEverest=="undefined"){
		 jQuery.getScript("FeiEditor/bitSite/js/jquery.vcsc.counteverest.min.js").done(function() {
			 jQuery('head').append('<link href="css/jquery.vcsc.counteverest.min.css" rel="stylesheet" type="text/css" />');
			 _bit_counterdown();
		 })
	 }else{
		 _bit_counterdown();
 ...
 function vc_plugin_flexslider() {
	 ...
	 if(typeof jQuery.fn.flexslider=="undefined"){
		 jQuery.getScript("qfy-content/plugins/qfy_editor/assets/lib/flexslider/jquery.flexslider-min.js").done(function() {
			 jQuery('head').append('<link href="css/flexslider.css" rel="stylesheet" type="text/css" />');
			...
			jQuery('.content-wrapper .qfy-listcatecontrols li').each(function(){
				...
				$li.mouseenter(function(){
					...
					if(jQuery(this).find(".toEditor").length==0){
						jQuery(this).append("<span class='toEditor' style='border:0;padding:0;'><span  style='display:inline;border:0;padding:0;background:transparent;' onclick='toDeleteCate(this)'><img src='images/close_hover.png' /></span>");
					}
				}).mouseleave(function(){
...
/* vc_transition_bootstrap_js: (https://www.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (https://www.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (https://www.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* dt-plugins: (https://www.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (https://www.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (https://www.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (https://www.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
...
function weiBoAndWeiXinToolTip(){
	...
	objs.each(function(){
		...
		obj.attr("title", '');
		var title="<img src='other/"+name+"'  width='160'/><div>请扫二维码关注微信</div>";
	...
	objs.each(function(){
		...
		var name = obj.attr("data-href");
		obj.attr("title", '');
		var title="<img src='other/"+name+"' width='160' /><div>请扫二维码关注微博</div>";
		var data = { tipJoint: "bottom",style: "dark" };
		new Opentip(obj, title, data);
	})
...
function toSubmitPhoneSms(){
	...
	var str ='<a class="bit-button-waiting" style="background:none;border:0;position:relative;"><img style=" height: 20px;margin-left: 10px;position: relative;top: 5px;" src="images/loading.gif"></a>';
        ...
        success: function(data) {
            if(data.indexOf("success")>-1){
				if(form.closest(".qfy-comments").length>0){
					...
					var success_htm = '<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="images/check.png" style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;">'+text4+'</div></div>';
...
function searchqfylist(tag,paged,flag){
	if(!is_edit_model){
		...
		//jQuery('.qfytemplateslist .qfy-template-content').block({ message: '<img src="images/preloader.gif" />',css: { backgroundColor: 'transparent',borderColor: 'transparent', margin:"0 0 0 -35px",left:"50%",width:'70px',height:'32px',padding:"8px 0 9px 0"},overlayCSS:{backgroundColor:"#F2F2F2",opacity:"0.9",} });
		jQuery('.qfytemplateslist .viewmoretemplate .viewmoretemplate_inner').hide();
		jQuery('.qfytemplateslist .viewmoretemplate').append("<div class='loadingimage' style='text-align:center;margin:50px auto;'><img style='vertical-align: middle;width:30px;' src='images/preloader.gif' /><span style='color:#0088c2;margin-left:10px;'>正在自动加载更多模板...</span></div>");
...
function checkAdvertising(){
	...
	var href = '../www.qifeiye.com/@tcode=freesite&uuid=_2F'+uuid;
...
function nav_pagemore(obj){
	...
	jQuery(obj).hide();
	jQuery(obj).after('<div class="qfy_list_loading"  style="margin:0 auto;text-align:center;"><img src="images/spinner.gif"><span style="color:#808080;font-size:12px;position: relative; top: -3px;">&nbsp;'+loadtext+'</span></div>');
...
function nav_customsearch(obj){
	...
	if(p.attr("data-ajax")=="1"){
		...
		var image_src = "images/loading.gif";
		var w = "";
		if(touuid!="-1"){
...
function quick_search(obj){
	...
	var bodywidth = jQuery("body").width();
	var bodyheight = jQuery(window).height();
	var message="<div><form action='default.htm'  onsubmit='return before_quick_search(this)'><input type='hidden'  name='searchtype' value='"+posttype+"' /><input type='hidden'  name='searchcate' value='"+postcate+"' /><input type='hidden' name='page_id' value='"+pageid+"'><div style='box-sizing: border-box;padding: 26px 24px 5px 24px;font-size: 18px;font-weight: 500;line-height: 24px;text-align: left;'>"+title+"</div>";
...
function login_button_click(id,link){
	...
	try{if(location.href.indexOf('qfy-login.php')>0) back = document.loginform.redirect_to.value;}catch(e){back = 'default.htm';}
...
function play_qfy_video(obj){
	...
	if(ispop=="1"){
		...
		jQuery(obj).removeClass("toplay").addClass("playing").attr("src","../fast.qifeiye.com/qfy-content/plugins/qfy_editor/projekktor/themes/maccaco/buffering.gif");
...
function open_user_detail(status,obj,curr_action,sider,$id,$paged){
		...
		if(sider=="order" && sider=="left"){
			...
			p.find(".bit-order-list:visible").prepend('<div class="user_loading" style="z-index:11;position:absolute;height:100%;width:100%;padding-top:200px; background: rgba(255,255,255,0.2);text-align: center;max-width: 100%;"><img src="images/loading.gif" /></div>');
		}else{
			if(width<992){
				isleft = true;
			}
			...
			p.find(".usermanage_content .bit-order-list").prepend('<div class="user_loading" style="z-index:11;position:absolute;height:100%;width:100%;padding-top:200px;background: rgba(255,255,255,0.2);text-align: center;max-width: 100%;"><img src="images/loading.gif" /></div>');
		}
		if(!is_edit_model){
			if(!sider) sider="";
			if(!$paged) $paged="0";
...
/* thickbox: (https://www.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* jquery-lazy: (https://www.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
